...
<body>
  <div>
    ...
    <!-- Main -->
    <main id="main" class="flexbox-col" style="background-image: url(&quot;./uploaded_images/maxresdefault.jpg&quot;);">
      <div id="row" style="display: flex; text-align: center; margin-top: 0%;">
        <div class="inner-column" style="padding: 0px; width: 20%; margin-left: 30%; margin-top: 0%; pointer-events: none;">
          ...
          <div class="imageContainer centered-image" data-index="0" style="width: 90%; height: 90%; margin-top: 6%; border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/2x1_NSwitch_KonosubaGodsBlessingOnThisWonderfulWorld_image1600w.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
        </div>
        <div>
      ...
      <div id="row" style="display: flex; margin-top: 10%;">
        <div id="column-suggested" class="column-container" style="width: 25%; margin-left: 10%; margin-top: 0%;">
          ...
          <div class="inner-column" style="padding: 0px; margin-top: 5%; pointer-events: none;">
            ...
            <div class="imageContainer" data-index="1" style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/Anime_KonoSuba_Aqua-1024x576.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
          </div>
              ...
              <div id="begginerGuide" style="height: 100%; overflow-y: auto;">
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer1" style="display: block;">
                    <iframe id="video1" src="https://www.youtube.com/embed/p37syJvrlro?si=tlBzOazzwhr5ovfR" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="display: block;"></iframe>
                ...
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer2" style="display: block;">
                    <iframe id="video2" src="https://www.youtube.com/embed/P0dw0WPGk90?si=cD5cptGwIw3guSGr" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="display: block;"></iframe>
                    <input type="text" class="video-input" id="urlInput2" placeholder="Inserisci URL del video" style="display: none;" disabled="">
                  </div>
                  <ul>
                    <li>
    ...
    <div class="fixed-card" style="max-height: 800px; display: none;">
      ...
      <div id="extwaiokist" style="display:none" v="pdbbg" q="6c230d98" c="814.5" i="821" u="19.31" s="05202423" sg="svr_09102316-ga_05202423-bai_05072421" d="1" w="false" e="" a="2" m="BMe=" vn="1gtra"><div id="extwaigglbit" style="display:none" v="pdbbg" q="6c230d98" c="814.5" i="821" u="19.31" s="05202423" sg="svr_09102316-ga_05202423-bai_05072421" d="1" w="false" e="" a="2" m="BMe="></div></div></div>
    ...
    <div id="newCommentModal" class="modal" style="display: none; position: fixed; z-index: 1; left: 0;	top: 0;	width: 100%; height: 100%; overflow: auto; background-color: rgba(0, 0, 0, 0.4);">
      <div class="modal-content">
        <form action="postMessages.php" method="post">            
          ...
          <input id="input-wiki" type="hidden" name="wiki" value="Konosuba">
