...
--
-- Host: 127.0.0.1
-- Creato il: Mag 31, 2024 alle 22:19
...
(20, '825336.jpg', './uploaded_images/825336.jpg'),
(21, 'Arrows_pack.png', './uploaded_images/Arrows_pack.png');
...
(1, 'Heart of Iron IV', 1, 'wiki dove parliamo di come prepararsi alla guerra', 'VideoGame', 'Heart_of_Iron_IV.php', '2024-05-18'),
...
(28, 'PUBG', 3, 'Battle Royale', 'VideoGame', 'PUBG.php', '2024-05-31'),
(29, 'battaglia\r\n                    ', 3, '\r\n                  Le mie battaglie', 'Post', '', '2024-05-31');
...
--
ALTER TABLE `immagini`
  MODIFY `ID_immagine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT per la tabella `messaggi`
--
ALTER TABLE `messaggi`
  MODIFY `ID_messaggio` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `wikipages`
  MODIFY `ID_wiki` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
