...
<body>
  <div>
    ...
    <!-- Main -->
    <main id="main" class="flexbox-col" style="background-image: url(&quot;./uploaded_images/NMhxKjGdQ21NnPG4rzwny977go_LzoF-hbY988P6C084-iPYewMuzZu3u6YpiVIH.png&quot;);">
      ...
      <div id="row" style="display: flex; margin-top: 10%;">
        <div id="column-suggested" class="column-container" style="width: 25%; margin-left: 10%; margin-top: 0%;">
          ...
          <div class="inner-column" style="padding: 0px; margin-top: 5%; pointer-events: none;">
            ...
            <div class="imageContainer" data-index="1" style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/artworks-eZd9iJexsBIGOG42-lqFRIg-t1080x1080.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
          </div>
          <div class="inner-column" style="margin-top: 0%; border-top-left-radius: 0px; border-top-right-radius: 0px;">
            ...
            <ul>
              <li>
                <a id="description" style="font-size: 12px; display: block; width: 100%; border: none;" contenteditable="false">Uno degli Hanime più noti direi</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div id="row" style="display: flex; margin-top: 0%; background-color: rgba(0, 0, 0, 0);">
            <div id="column-news" class="column-container" style="width: 55%; margin-left: 5%; margin-right: 6%; text-align: center;">
              <div class="inner-column" style="margin-top: 0%; padding: 10px; text-align: center; display: flex; justify-content: center;">
                  ...
                  <div id="extwaiokist" style="display:none" v="pdbbg" q="6c230d98" c="814.7" i="821" u="23.61" s="05202423" sg="svr_09102316-ga_05202423-bai_05072421" d="1" w="false" e="" a="2" m="BMe=" vn="1gtra"><div id="extwaigglbit" style="display:none" v="pdbbg" q="6c230d98" c="814.7" i="821" u="23.61" s="05202423" sg="svr_09102316-ga_05202423-bai_05072421" d="1" w="false" e="" a="2" m="BMe="></div></div></div>
              </div>
              <div id="Forum">
              ...
              <div id="begginerGuide" style="height: 100%; overflow-y: auto;">
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer1" style="display: block;">
                    <iframe id="video1" src="https://www.youtube.com/embed/oChhjOfkhrw?si=XnOjflXDKZgnuqiM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="display: block;"></iframe>
                ...
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer2" style="display: block;">
                    <iframe id="video2" src="https://www.youtube.com/embed/8u-XoaU4ScA?si=ylZSBHxYVFY1Jf0W" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="display: block;"></iframe>
