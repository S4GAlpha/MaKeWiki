...
<body>
  <div>
    ...
    <!-- Main -->
    <main id="main" class="flexbox-col" style="background-image: url(&quot;./uploaded_images/825336.jpg&quot;);">
      <div id="row" style="display: flex; text-align: center; margin-top: 0%;">
        <div class="inner-column" style="padding: 0px; width: 20%; margin-left: 30%; margin-top: 0%; pointer-events: none;">
          ...
          <div class="imageContainer centered-image" data-index="0" style="width: 90%; height: 90%; margin-top: 6%; border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/825336.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
        </div>
        <div>
          <ul style="display: flex; align-items: center; justify-content: center; height: 70%;">
            <li>
              <h2 id="textTitle" style="margin-top: 10%; font-size: 30px; display: block; width: 100%; margin-left: 30px; border: none;" contenteditable="false">PUBG</h2>
            </li>
          </ul>
          <ul>
            <li>
      ...
      <div id="row" style="display: flex; margin-top: 10%;">
        <div id="column-suggested" class="column-container" style="width: 25%; margin-left: 10%; margin-top: 0%;">
          ...
          <div class="inner-column" style="padding: 0px; margin-top: 5%; pointer-events: none;">
            ...
            <div class="imageContainer" data-index="1" style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/825336.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
          </div>
          <div class="inner-column" style="margin-top: 0%; border-top-left-radius: 0px; border-top-right-radius: 0px;">
            ...
            <h2 id="gameI" style="display: block;">Info Game</h2>
            <ul>
              <li>
                <a id="description" style="font-size: 12px; display: block; width: 100%; border: none;" contenteditable="false">Battle Royale</a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div id="begginerGuide" style="height: 100%; overflow-y: auto;">
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer1" style="display: block;">
                    ...
                    <input type="text" class="video-input" id="urlInput1" placeholder="Inserisci URL del video" disabled="">
                  </div>
                  <ul>
                    <li>
        ...
        <div id="game" style="display: block; width: 100%; margin-right: 6%; text-align: center;">
          <div id="row" style="display: flex; margin-top: 0%; background-color: rgba(0, 0, 0, 0);">
            <div id="column-news" class="column-container" style="width: 55%; margin-left: 5%; margin-right: 6%; text-align: center;">
              <div class="inner-column" style="margin-top: 0%; padding: 10px; text-align: center; justify-content: center; width: 100%; overflow-x: auto;">
                <div style="display: flex;">
                  <div class="collapse" id="collapseFirst" style="margin-left: 0px; display: block;">
                    <ul>
                      <li>
                        <a id="collapseFirst" onclick="toggleDiv('first', this)" style="font-size: 12px; display: block; width: 100%; border: none;" contenteditable="false">Armi</a>
                      </li>
                    </ul>
                  </div>
              ...
              <div id="first" class="card-content" style="display: block;"><div>
                <div class="inner-column" style="padding: 0px; text-align: center; margin-top: 5%; pointer-events: none;">
                    <div style="padding: 0px; width: 100%; margin-left: 0%; margin-top: 0%; border-bot-left-radius: 0px; border-bot-right-radius: 0px;">
                        <img src="images/navbar/new-wiki.png" class="customButton centered-image" data-index="17" alt="" style="width: 20%; height: 50%; margin-top: 12%; display: none;">
                        <form class="uploadForm" enctype="multipart/form-data" style="display: none;">
                            <input type="file" class="fileInput" data-index="17" accept="image/*">
                        </form>
                        <div class="imageContainer centered-image" data-index="17" style="width: 90%; height: 90%; margin-top: 6%; border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"><img src="./uploaded_images/825336.jpg" style="width: 100%; height: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;"></div>
                    </div>
                    <div>
                        <ul>
                            <li>
                                <a class="contenteditable" style="font-size: 12px; display: block; width: 80%; margin-left: 10%; border: none;" contenteditable="false">
                                    Inserisci qui la descrizione 1
                                </a><br>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="inner-column" style="padding: 0px; text-align: center; margin-top: 5%; pointer-events: none;">
                    <div style="padding: 0px; width: 100%; margin-left: 0%; margin-top: 0%; border-bot-left-radius: 0px; border-bot-right-radius: 0px;">
                        <img src="images/navbar/new-wiki.png" class="customButton centered-image" data-index="18" alt="" style="width: 20%; height: 50%; margin-top: 12%;">
                        <form class="uploadForm" enctype="multipart/form-data" style="display: none;">
                            <input type="file" class="fileInput" data-index="18" accept="image/*">
                        </form>
                        <div class="imageContainer centered-image" data-index="18" style="width: 90%; height: 90%; margin-top: 6%; border-top-left-radius: 10px; border-top-right-radius: 10px; border-bot-left-radius: 0px; border-bot-right-radius: 0px;"></div>
                    </div>
                    <div>
                        <ul>
                            <li>
                                <a class="contenteditable" style="font-size: 12px; display: block; width: 80%; margin-left: 10%; border: none;" contenteditable="false">
                                    Inserisci qui la descrizione 2
                                </a><br>
                            </li>
                        </ul>
                    </div>
              ...
              <div id="video" style="height: 100%; overflow-y: auto;">
                ...
                <div class="inner-column" style="margin-top: 5%; padding: 0px; height: 40%; margin-right: 10px;">
                  <div class="video-container" id="videoContainer5" style="display: block;">
                    <iframe id="video5" src="https://www.youtube.com/embed/URBy9t6e8rY?si=iEuRC8J8_D0jLqYP" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="display: block;"></iframe>
                    <input type="text" class="video-input" id="urlInput5" placeholder="Inserisci URL del video" style="display: none;" disabled="">
                  </div>
                  <ul>
                    <li>
      ...
      <div id="extwaiokist" style="display:none" v="pdbbg" q="6c230d98" c="820.7" i="827" u="0.002" s="05302400" sg="svr_09102316-ga_05302400-bai_05232420" d="1" w="false" e="" a="2" m="BMe=" vn="1gtra"><div id="extwaigglbit" style="display:none" v="pdbbg" q="6c230d98" c="820.7" i="827" u="0.002" s="05302400" sg="svr_09102316-ga_05302400-bai_05232420" d="1" w="false" e="" a="2" m="BMe="></div></div></div>
    </main>
    ...
    <div class="fixed-card" style="max-height: 800px; display: none;">
      ...
      <div id="cardSlider" style="display: block;">
      ...
      <div id="contentSlidersContainer" style="display: block; max-height: 230px; overflow-y: auto;"><div> 
                <label style="font-size: 12px;" for="contentRange0">Numero dei contenuti per scheda 1: <span id="contentValue0">3</span></label>
                <input type="range" id="contentRange0" min="0" max="100" value="0" oninput="updateContent(0, this.value); updateContentLabel(0, this.value);">
            </div></div>
        <div>
    ...
    <div id="newCommentModal" class="modal" style="display: none; position: fixed; z-index: 1; left: 0;	top: 0;	width: 100%; height: 100%; overflow: auto; background-color: rgba(0, 0, 0, 0.4);">
      <div class="modal-content">
        <form action="postMessages.php" method="post">            
          <input id="input-email" type="hidden" name="email" value="piergiorgio@gmail.com">
          <input id="input-wiki" type="hidden" name="wiki" value="PUBG">
