...
<head>
    ...
    <style>
        #main {
            background-image: url(images/img/wikiPage/game/elden-ring/ERWallpaper.jpg);
  ...
  <!-- Main -->
    <main id="main" class="flexbox-col">
        <div id="row" style="display: flex; text-align: center; margin-top: 0%;">
            <img style="width: 200px; height: 100px; margin-left: 35%;" src="images/img/wikiPage/game/elden-ring/er-logo.jpg" alt="Account Icon"/>
            <div>
                <h2 style="margin-left: 30px;">Elden Ring</h2>
                <a style="font-size: 12px;">From Software</a>
            </div>
            ...
            <div id="column-news" class="column-container" style="width: 55%; margin-left: 5%; margin-right: 6%; text-align: center;">
                <div class="inner-column" style="margin-top: 0%; padding: 10px; text-align: center; display: flex; justify-content: center;">
                    <div style="margin-left: 0px;">
                        <a id="collapseFirst" onclick="toggleFirst()">Characters</a>
                    </div>
                    <div style="margin-left: 5%;">
                        <a id="collapseSecond" onclick="toggleSecond()">Items</a>
                    </div>
                    <div style="margin-left: 5%;">
                        <a id="collapseThird" onclick="toggleThird()">Enemies</a>
                    </div>
                    <div style="margin-left: 5%;">
                        <a id="collapseFour" onclick="toggleFour()">Location</a>
                    </div>
                </div>
