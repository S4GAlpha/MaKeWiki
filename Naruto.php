...
<head>
    ...
    <style>
        #main {
            background-image: url(images/img/wikiPage/anime/Naruto/narutoWallpaper.jpg);
  ...
  <!-- Main -->
    <main id="main" class="flexbox-col">
        <div id="row" style="display: flex; text-align: center; margin-top: 0%;">
            <img style="width: 200px; height: 100px; margin-left: 35%;" src="images/img/wikiPage/anime/Naruto/naruto-logo.jpg" alt="Account Icon"/>
            <div>
                <h2 style="margin-left: 30px;">Naruto</h2>
                <a style="font-size: 12px;">Masashi Kishimoto</a>
            </div>
        ...
        <div id="row" style="display: flex; margin-top: 10%;">
            <div id="column-suggested" class="column-container" style="width: 25%; margin-left: 10%; margin-top: 0%;">
                ...
                <div class="inner-column" style="padding: 0px;  margin-top: 5%;">
                    <img src="images/img/wikiPage/anime/Naruto/imageNaruto.jpg" alt="" class="centered-image" style="border-top-left-radius: 10px; border-top-right-radius: 10px;"/>
                </div>
                <div class="inner-column" style="margin-top: 0%; border-top-left-radius: 0px; border-top-right-radius: 0px;">
                    <h2>Info Anime</h2>
                    <ul>
                        <li>
                            <a style="font-size: 12px;">Naruto (NARUTO -ナルト-?) è un manga scritto e disegnato da Masashi Kishimoto e pubblicato dal 4 ottobre 1999 al 10 novembre 2014 sulla rivista Weekly Shōnen Jump di Shūeisha, per un totale di 15 anni di serializzazione. I 700 capitoli realizzati sono stati raccolti in 72 volumi tankōbon sotto l'etichetta Jump Comics; il manga è stato tradotto e pubblicato in diverse lingue, tra cui in inglese da Viz Media, in italiano da Planet Manga, in francese da Kana, in tedesco da Banzai! e in spagnolo da Glénat. La trama segue le peripezie e le vicissitudini del giovane Naruto Uzumaki, il quale, partendo da ninja inetto e diventando via via più forte, cerca di cambiare il suo mondo, inseguendo il sogno di diventare hokage. Dal manga sono state tratte due serie televisive anime entrambe prodotte dalla Pierrot e andate in onda su TV Tokyo: la prima, Naruto (NARUTO -ナルト-?), trasmessa in Giappone dal 3 ottobre 2002 all'8 febbraio 2007, è composta da 220 episodi e adatta i primi 27 volumi del fumetto; la seconda, Naruto: Shippuden (NARUTO -ナルト-疾風伝?, Naruto: Shippūden, lett. "Naruto: Le cronache dell'uragano"), trasmessa in Giappone dal 15 febbraio 2007 al 23 marzo 2017, è composta da 500 episodi e adatta il seguito della vicenda a partire dal volume 28. La serie è stata inoltre trasposta in altri media come romanzi, videogiochi, film e OAV. Naruto, con le sue oltre 250 milioni di copie, è diventato il quinto manga più venduto al mondo, dietro One Piece, Golgo 13, Detective Conan e Dragon Ball[1].</a>
                        </li>
                    </ul>
                </div>
            </div>
