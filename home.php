...
<head>
  ...
  <link rel="stylesheet" href="./home_page_style.css">
      <!--style>
        body {
            <?php if(isset($_SESSION['sfondo'])): ?>
                background-image: url(<?php echo $_SESSION['sfondo']; ?>);
            <?php else: ?>
    ...
    <ul class="navbar-items flexbox-col">
      ...
      <li class="navbar-item flexbox-left">
        <a class="navbar-item-inner flexbox-left">
          <div class="navbar-item-inner-icon-wrapper flexbox">
            <!--ACCOUNT-->
            <img style="width: 20px; height: 20px;" src="images/navbar/users.png" alt="Home Icon" />
          </div>
      ...
      <li class="navbar-item flexbox-left">
        <a class="navbar-item-inner flexbox-left">
          <div class="navbar-item-inner-icon-wrapper flexbox">
            <!--IMPOSTAZIONI PAGINA-->
            <img style="width: 20px; height: 20px;" src="images/navbar/setting.png" alt="Home Icon" />
          </div>
